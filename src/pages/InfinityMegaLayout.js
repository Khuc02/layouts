      ...
      <div className="flex">
        <div className="w-1/2 h-full">
          <div className="px-14 flex">
            ...
            <div className="pl-8">
              <div>
                <h1 className="mt-20 font-bold text-5xl text-black">infinity</h1>
              ...
              <div>
                ...
                <div className="flex my-8">
                  ...
                  <div className="flex flex-col items-center text-center">
                    <h2 className="text-lg font-semibold text-[#B45A20]">360°</h2>
        ...
        <div className="w-1/2 h-full flex items-center justify-center">
          <div className="w-[45%] mt-20 bg-white flex flex-col items-center">
            <div className="flex justify-between w-full mb-1.5">
              <img src={Tile} alt="Tile 1" className="w-[49%]" />
              <img src={Tile} alt="Tile 2" className="w-[49%]" />
            </div>

            <div className="flex justify-between w-full">
              <img src={Tile} alt="Tile 3" className="w-[49%]" />
              <img src={Tile} alt="Tile 4" className="w-[49%]" />
            </div>
